          ...
          <div className="flex   flex-col space-y-8 justify-between">
            <div className="font-bold border-b border-yellow-300 text-4xl tracking-wide">
             ...
             <div className="flex flex-col space-y-8" >
                ...
                <a className="" href="mailto:mohdmujassimjmi@gmail.com"><span>mohdmujassimjmi@gmail.com</span></a> 
                </div>
                <div className="inline-flex space-x-2 items-center">
                <ion-icon className=' text-xl scale-110 ' name="pin"/>
                <span>Okhla,Jamia Nagar New Delhi,India</span>
                </div>
             </div>
            ...
            <a className="hover:scale-125  hover:text-yellow-300" target="_blank" href="https://www.linkedin.com/in/mohd-mujassim/"><ion-icon name="logo-linkedin"></ion-icon></a>
            <a className="hover:scale-125  hover:text-yellow-300" target="_blank" href="https://github.com/MohdMujassim"><ion-icon name="logo-github"></ion-icon></a>
            </div>
     </div>
          {/* ----contact---form---- */}
          <div>
